...
<div class="card">
    <div class="card-body">
        <form method="post" action="<?php echo base_url('users/process_edit'); ?>">
                            ...
                            <?php if (!empty($roles) && is_array($roles)): ?>
                                <?php foreach ($roles as $role): ?>
                                    <option value="<?php echo $role->id; ?>" 
                                            <?php echo set_select('role_id', $role->id, ($role->id == $user->role_id)); ?>>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            <option value="1" <?php echo set_select('status', '1', ($user->status == 1)); ?>>Active</option>
                            <option value="0" <?php echo set_select('status', '0', ($user->status == 0)); ?>>Inactive</option>
                        </select>
