...
|
*/
$config['base_url'] = 'http://localhost/lacrm/';
...
|
*/
$config['log_threshold'] = 4; // Enable all logging (0=off, 1=error, 2=debug, 3=info, 4=all)
...
|--------------------------------------------------------------------------
|
| This is the location where HMVC modules will be stored
|
*/
